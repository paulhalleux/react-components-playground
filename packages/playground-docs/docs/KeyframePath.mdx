...
<Properties properties={[
  { name: "position", type: "{ x: number, y: number }", description: "The position of the keyframe.", required: true },
  { name: "time", type: "number", description: "The time of the keyframe.", required: true },
  { name: "interpolation", type: "{ type: 'linear' | 'bezier', p1: Point, p2: Point }", description: "The bezier handles of the keyframe." },
]} />