...
export const ComponentList: Record<string, ComponentMeta> = {
  Toast: {"title":"Toast","category":"Components","description":"A component to display toasts","icon":"NotificationIcon","status":"done","fileName":"Toast"},
  Tabs: {"title":"Tabs","category":"Components","description":"A component to display tabs","icon":"TabsIcon","status":"done","fileName":"Tabs"},
  Table: {"title":"Table","category":"Components","description":"A component to display a table","icon":"TableIcon","status":"done","fileName":"Table"},
