...
export const ComponentList: Record<string, ComponentMeta> = {
  ...
  Selector: {"title":"Selector","category":"Experimental","description":"A component to select a value","icon":"SelectionFrameIcon","status":"draft","fileName":"Selector"},
  KeyframePath: {"title":"KeyframePath","category":"Experimental","description":"A component to display a path with keyframes","icon":"PointerIcon","status":"draft","fileName":"KeyframePath"},
  FrameSelector: {"title":"FrameSelector","category":"Experimental","description":"A component to select a frame","icon":"SelectionIcon","status":"draft","fileName":"FrameSelector"},
